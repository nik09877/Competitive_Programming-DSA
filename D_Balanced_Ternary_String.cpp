...
void solve()
{
    ...
    int cnt = (cnt0 + cnt1 + cnt2) / 3;
    int ans = 0;

    if (a[2].size() > cnt)
    {
        while (a[2].size() > cnt and a[0].size() < cnt)
        {
            ans++;
            auto it = a[2].begin();
            a[0].insert(*it);
        ...
        while (a[2].size() > cnt and a[1].size() < cnt)
        {
            ans++;
            auto it = a[2].begin();
            a[1].insert(*it);
    ...
    if (a[1].size() > cnt)
    {
        while (a[1].size() > cnt and a[0].size() < cnt)
        {
            ans++;
            auto it = a[1].begin();
            a[0].insert(*it);
        ...
        while (a[1].size() > cnt and a[2].size() < cnt)
        {
            ans++;
            auto it = prev(a[1].end());
            a[2].insert(*it);
            a[1].erase(it);
        }
    }
    if (a[0].size() > cnt)
    {
        while (a[0].size() > cnt and a[2].size() < cnt)
        {
            ans++;
            auto it = prev(a[0].end());
            a[2].insert(*it);
            a[0].erase(it);
        }
        while (a[0].size() > cnt and a[1].size() < cnt)
        {
            ans++;
            auto it = prev(a[0].end());
            a[1].insert(*it);
