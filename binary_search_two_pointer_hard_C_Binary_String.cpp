...
/*
Binary search on the cost m
 we can delete at most m 1's
 our string should have at most m 0's

put position of 1's in an array
 check if you delete i no of 1's from beginning and m-i 1's from end
 how many 0's are there in [i+1,(m-i-1)]
 if possible then good else not good

 OR

put position of 0's in an array
 you can have at most mid no. of zero's, let i be the starting position of first 0,so
 position of last 0 will be i+mid-1
 Now check excluding this range [i,i+mid-1] how many 1's we need to delete.
c*/
