...
// clang-format on
//! if you have 2 coprime divisors it is always possible to move one step right using some combination of jumps
//for n=6 divisors ->2,3
//0+3->3-2->1+3->4-2->2 so all of them should have same colour
//so if gcd of all divisors is g we can move atleast g step ahead ,so g colours are required
int main()
{
    setIO();
