...
<strong>Explanation:</strong> Each circle contains the node number in black and its <span><code>distanceToLastNode value in blue. </code></span>The three restricted paths are:
1) 1 --&gt; 2 --&gt; 5
2) 1 --&gt; 2 --&gt; 3 --&gt; 5
3) 1 --&gt; 3 --&gt; 5
</pre>
...
<strong>Explanation:</strong> Each circle contains the node number in black and its <span><code>distanceToLastNode value in blue. </code></span>The only restricted path is 1 --&gt; 3 --&gt; 7.
</pre>
...
<div><div>Related Topics</div><div><li>Dynamic Programming</li><li>Graph</li><li>Topological Sort</li><li>Heap (Priority Queue)</li><li>Shortest Path</li></div></div><br><div><li>👍 1124</li><li>👎 216</li></div>