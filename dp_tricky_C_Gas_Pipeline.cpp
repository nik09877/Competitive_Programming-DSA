...
int getAns(int i, int prev_height)
{
    //if s[i]=='1' that means height of prev pillar and the next pillar must be of height 2,so it is not allowed to have prev_height 0 if s[i]=='1'
    if (s[i] == '1' && !prev_height)
        return 1e14;
