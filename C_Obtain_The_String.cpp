...
void solve()
{
    ...
    int operations = 0, find_next_char_having_pos_greater_than_equal_to_this = 0, i = 0;
    while (i < sz(t))
    {
        if (s[t[i] - 'a'].empty())
        {
        ...
        auto it = s[t[i] - 'a'].lower_bound(find_next_char_having_pos_greater_than_equal_to_this);
        if (it == s[t[i] - 'a'].end())
        {
            operations++;
            find_next_char_having_pos_greater_than_equal_to_this = 0;
        }
        else
        {
            i++;
            find_next_char_having_pos_greater_than_equal_to_this = *it;
            find_next_char_having_pos_greater_than_equal_to_this++;
        }
    }
    operations++;
    prln(operations);
