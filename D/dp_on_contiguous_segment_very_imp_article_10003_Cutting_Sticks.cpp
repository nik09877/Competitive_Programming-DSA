...
// {
//     //if length of stick is one,we can't cut it further
//     if (right - left == 1)
//         return 0;
...
//         return ans;
//     ans = INT_MAX;
//     for (int cut_point = 1; cut_point <= n; cut_point++)
//     {
//         int temp_ans = getAns(left, cut_point) + getAns(cut_point, right) + a[right] - a[left];
...
//     //Initially length of the stick is n,so the number of points that make up a stick of length n is n+1.
//     // so dp[0][n+1] denotes the minimum cost for cutting the stick of length L;Here 0 to n+1 are points
//     cout << "The minimum cutting is " << getAns(0, n + 1) << "." << endl;
//     return;
// }
// int32_t main()
// {
