...
// lli dp[100005][2][2];
// lli a[3][100005];
// lli getAns(int i, int first, int second)
// {
//     if (i > n)
//         return 0;
...
//     if (!first and !second)
//     {
//         x = a[1][i] + getAns(i + 1, 1, 0);
//         y = a[2][i] + getAns(i + 1, 0, 1);
//         z = getAns(i + 1, 0, 0);
//     }
//     else if (first == 0 and second == 1)
//     {
//         x = a[1][i] + getAns(i + 1, 1, 0);
//         y = getAns(i + 1, 0, 0);
//     }
//     else if (first == 1 and second == 0)
//     {
//         x = a[2][i] + getAns(i + 1, 0, 1);
//         y = getAns(i + 1, 0, 0);
//     }
//     return dp[i][first][second] = max({x, y, z});
// }
// void solve()
// {
//     cin >> n;
